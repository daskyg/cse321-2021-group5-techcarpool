...
$(function() {
    ...
    var clientKey = "js-Uvkizrtt35WzOZ1uAyPTteo1qK72ikaAtme2CASNHGpvqH6mG6akeOnTHXLPOqli";
...
function calculateRouteFromAtoB(platform) {
    var router = platform.getRoutingService(null, 8),
        routeRequestParams = {
            routingMode: 'fast',
            transportMode: 'car',
            origin: '34.805663444,-106.734497062', // Los Lunas NM
            destination: '34.0660,-106.9056', // Socorro NM
...
var platform = new H.service.Platform({
    apikey: "xy0ffiYd5r7P4XUbhPlGLj4OPdgWeuveXmPO6Ifs50A"
});

var defaultLayers = platform.createDefaultLayers();

// Step 2: initialize a map - this map is centered over Socorro
var map = new H.Map(mapContainer,
    defaultLayers.vector.normal.map, {
        center: {lat: 34.0660, lng: -106.9056},
        zoom: 13,
